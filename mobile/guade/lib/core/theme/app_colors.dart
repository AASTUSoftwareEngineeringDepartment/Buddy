...
class AppColors {
  // Primary Colors - Reddish
  static const Color primary = Color(0xFFE53935); // Strong red
  static const Color primaryLight = Color(0xFFFF6F60); // Lighter red
  static const Color primaryDark = Color(0xFFAB000D); // Darker red

  // Secondary Colors - Fun and engaging
  static const Color secondary = Color(0xFF4CAF50); // Bright green
  ...
  static const Color accent1 = Color(0xFFFF7043); // Orange-red
  static const Color accent2 = Color(0xFF2196F3); // Bright blue
  static const Color accent3 = Color(0xFFE91E63); // Bright pink

  // Background Colors - Soft and easy on eyes
  static const Color background = Color(0xFFFFEBEE); // Very light red/pink
  static const Color surface = Color(0xFFFFFFFF); // Pure white
  static const Color cardBackground = Color(0xFFFFCDD2); // Light red
